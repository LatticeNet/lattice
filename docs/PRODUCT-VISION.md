...
> in iter-018), shared nft-input persistence landed in iter-019, and Design 05's
> `NetPolicy` state/API/graph/dashboard foundation landed in iter-020. See
