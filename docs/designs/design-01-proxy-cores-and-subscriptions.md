...
dashboard subscription import helpers, and proxy collector health/error
surfacing. True sing-box/xray API transports and xray rendering remain pending.
