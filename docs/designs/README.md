...
3. **01 Proxy cores & subscriptions** — the flagship and largest. The
   ...
   plain/base64 subscription endpoint are now landed; next ship the dashboard
   proxy UI, usage reporting, richer subscription formats, and xray.
