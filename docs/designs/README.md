...
3. **01 Proxy cores & subscriptions** — the flagship and largest. The
   persistence/proto foundation is now landed; next ship MVP renderer/API in
   narrow slices: vless+reality+tcp config render, reviewed proxycore
   plan/apply, then expiry-only subscriptions.
