...
3. **01 Proxy cores & subscriptions** — the flagship and largest. The
   ...
   loopback HTTP/V2Ray-stats collector foundation in the node-agent. Next ship
   the true sing-box/xray API transport, usage notifications, subscription
   import helpers, and xray rendering.
