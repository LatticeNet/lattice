...
Remaining Design 05 work is domain/DDNS-backed nft sets, IPv6, bulk geo import,
and map overlays. Designs 01/02/03 remain design-ready but unbuilt. Each
...
1. **05 network ACL domain sets + map polish** — continue from iter-024:
   ingress composition is now folded into `lattice_guard`; next add a safe
