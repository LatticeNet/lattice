...
that control-plane set. Remaining Design 05 work is domain remotes, IPv6,
non-systemd scheduling, bulk geo import, and map overlays. Designs 01/02/03 remain
...
1. **05 network ACL domain remotes/IPv6 + map polish** — continue from iter-028:
   ...
   with systemd periodic refresh; next add domain-valued operator remotes and
   IPv6, then
