...
3. **01 Proxy cores & subscriptions** — the flagship and largest. The
   ...
   plain/base64 subscription endpoint are now landed. Iter-045 adds the
   dashboard proxy panel plus audited rotate/copy subscription URL flow; next
   ship usage reporting, richer subscription formats, and xray.
