...
reports mutate the accounting baseline.
...
3. **01 Proxy cores & subscriptions** — the flagship and largest. The
   ...
   health/error surfacing. Next ship the true sing-box/xray API transport and
   xray rendering.
