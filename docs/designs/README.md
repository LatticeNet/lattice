...
3. **01 Proxy cores & subscriptions** — the flagship and largest. The
   ...
   added server-owned quota/expiry notifications. Next ship the true
   sing-box/xray API transport, subscription import helpers, and xray rendering.
