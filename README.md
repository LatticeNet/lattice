...
Current published SDK baseline: latest `lattice-sdk` tag is `v0.2.12`;
`lattice-server` consumes `v0.2.12`, and `lattice-node-agent` consumes
`v0.2.10`. The workspace `use` list includes the local SDK checkout, so
